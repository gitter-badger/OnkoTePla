	...
	public class AppointmentGridDisplayDataSet : IDisposable
	{
											  ...
											  GlobalState<Guid?> selectedRoomState)
		{
			...
			foreach (var room in medicalPractice.Rooms)
				...
				{
					allTherapyPlaceRows.Add(new TherapyPlaceRowViewModel.TherapyPlaceRowViewModel(therapyPlace, room.DisplayedColor, timeSlotStart, timeSlotEnd));
				}
		...
		{
			displayedAppointments.Add(new AppointmentViewModel.AppointmentViewModel(appointment, allTherapyPlaceRows, appointmentGridViewModel));
		}	
