...
{
	public class LabelAddedNotification : NetworkMessageBase
	{
		public LabelAddedNotification (Label label, ConnectionSessionId sessionId)
		...
		public static LabelAddedNotification Parse(string s)
		{
			...
			return new LabelAddedNotification(new Label(name, color, id), sessionId);
		}
	}
}