...
namespace bytePassion.OnkoTePla.Contracts
{
	public static class CommunicationSampleData
	{
		static CommunicationSampleData()
		{
			...
			{
				new Appointment(PatientList[0], listOfTherapyPlaces[0],MedicalPractice.Rooms[0]  ,new DateTime(2015, 4, 16, 10, 15, 00), new DateTime(2015, 4, 16, 11, 30, 00)),
				new Appointment(PatientList[0], listOfTherapyPlaces[3],MedicalPractice.Rooms[1]  ,new DateTime(2015, 4, 20, 10, 15, 00), new DateTime(2015, 4, 20, 11, 30, 00)),
				new Appointment(PatientList[1], listOfTherapyPlaces[1],MedicalPractice.Rooms[0]  ,new DateTime(2015, 4, 17, 11, 00, 00), new DateTime(2015, 4, 17, 12, 30, 00)),
				new Appointment(PatientList[2], listOfTherapyPlaces[1],MedicalPractice.Rooms[0]  ,new DateTime(2015, 4, 21,  9, 00, 00), new DateTime(2015, 4, 21, 10, 00, 00)),
				new Appointment(PatientList[2], listOfTherapyPlaces[4],MedicalPractice.Rooms[1]  ,new DateTime(2015, 4, 16, 15, 30, 00), new DateTime(2015, 4, 16, 16, 30, 00)),
				new Appointment(PatientList[3], listOfTherapyPlaces[2],MedicalPractice.Rooms[0] ,new DateTime(2015, 4, 16, 10, 15, 00), new DateTime(2015, 4, 16, 11, 30, 00))
			};
		}
